  ...
  ],
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background shadow-sm  data-[hovered]:bg-accent data-[hovered]:text-accent-foreground data-[pressed]:bg-accent/80",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm data-[hovered]:bg-secondary/80 data-[pressed]:bg-secondary/60",
        ghost:
